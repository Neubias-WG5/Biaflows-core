...
var ExplorerTabs = Backbone.View.extend({
    ...
    addDashboard: function (dashboard) {
        ...
        tabs.append(_.template("<li class='custom-ui-project-benchmark-tab' id='project-benchmark-tab' style='display:none;'><a href='#tabs-benchmark-<%= idProject %>' data-toggle='tab'><i class='icon-tasks' /> Benchmarking</a></li>", { idProject: window.app.status.currentProject}));
